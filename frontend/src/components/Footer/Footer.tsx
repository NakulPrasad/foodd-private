      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='py-7 border-t border-gray-200'>
          <div className='flex items-center justify-center flex-col lg:justify-between lg:flex-row'>
            <span className='text-sm text-gray-500 '>By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. 2008-2024 © Foodd™ Ltd. All rights reserved.</span>
